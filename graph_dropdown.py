...
def graph_ism_pmi(years):
    ...
    ism_pmi = pd.read_csv('ism_manufacturing_pmi.csv')
...
def graph_housing_starts(years):
    ...
    housing_starts = pd.read_csv('housing_starts.csv')
...
def graph_nonfarm_payroll(years):
    ...
    nonfarm_payroll = pd.read_csv('nonfarm_payroll.csv')
...
def graph_initial_jobless_claims(years):
    ...
    initial_jobless_claims = pd.read_csv('initial_jobless_claims.csv')
...
def graph_industry_production_index(years):
    ...
    industry_production_index = pd.read_csv('industry_production_index.csv')
...
def graph_durable_goods_orders(years):
    ...
    durable_goods = pd.read_csv('durable_goods_orders.csv')
...
def graph_producer_price_index(years):
    ...
    producer_price_index = pd.read_csv('producer_price_index.csv')
...
def graph_feds_funds_rate(years):
    ...
    feds_funds = pd.read_csv('feds_funds_rate.csv')
...
def graph_10_year_treasury_yield(years):
    ...
    ten_year_treasury_yield = pd.read_csv('10_year_treasury.csv')
...
def graph_average_hourly_earnings(years):
    ...
    average_hourly_earnings = pd.read_csv('average_hourly_earnings.csv')
...
def graph_commercial_industrial_loans(years):
    ...
    commercial_industrial_loans = pd.read_csv('commercial_industrial_loans.csv')
