...
def get_nonfarm_payroll():
    ...
    payems.to_csv('nonfarm_payroll.csv')
...
def get_initial_jobless_claims():
    ...
    icsa.to_csv('initial_jobless_claims.csv')
...
def get_personal_income():
    ...
    personal_income.to_csv('personal_income.csv')
...
def get_industry_production_index():
    ...
    indpro.to_csv('industry_production_index.csv')
...
def get_capacity_utilization():
    ...
    tcu.to_csv('capacity_utilization.csv')
...
def get_durable_goods_orders():
    ...
    dgo.to_csv('durable_goods_orders.csv')
...
def get_producer_price_index():
    ...
    ppi.to_csv('producer_price_index.csv')
...
def get_feds_funds_rate():
    ...
    ffr.to_csv('feds_funds_rate.csv')
...
def get_10_year_treasury():
    ...
    ten_year_treasury.to_csv('10_year_treasury.csv')
...
def get_average_hourly_earnings():
    ...
    ahe.to_csv('average_hourly_earnings.csv')
...
def get_commercial_industrial_loans():
    ...
    cil.to_csv('commercial_industrial_loans.csv')
